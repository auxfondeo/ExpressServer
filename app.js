...
app.post("/login", (req, res) => {
    ...
    if ((username === 'alberto' && password === 'uwu') || (username === 'Vanessa' && password === 'VALORA') || (username === 'Marco' && password === 'pokemon') || username === 'Michelle' && password === 'Rayados' ) {
...
app.post("/concatenar", (req, res) => {
    ...
    const pythonScript = "C:/Users/alber/Documents/Archivos de Python/Correos/Main.py";
...
app.post("/Cartas", (req,res) => {
    //Variables para crear el nombre
    const Paterno = req.body.ApPat;
    const Materno = req.body.ApMat;
    const Nombres = req.body.Nombres;
    ...
    console.log("Fecha de descuentos:",fecha);
    console.log("Numero:",Numero)

    
    const pythonScript = "C:/Users/alber/Documents/Archivos de Python/Cartera/cartas.py";

    const pythonProcess = spawn("python", [pythonScript, nombreCompleto,Plazo,fecha,Numero]);
